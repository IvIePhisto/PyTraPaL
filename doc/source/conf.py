# -*- coding: utf-8 -*-
#
# PyTraPaL documentation build configuration file, created by
# sphinx-quickstart on Sat Nov  9 17:39:30 2013.
#
...
latex_documents = [
  ('index', 'PyTraPaL.tex', u'PyTraPaL Documentation',
...
man_pages = [
    ('index', 'pytrapal', u'PyTraPaL Documentation',
     [u'Michael Pohl'], 1)
]
...
texinfo_documents = [
  ('index', 'PyTraPaL', u'PyTraPaL Documentation',
   u'Michael Pohl', 'PyTraPaL', 'One line description of project.',
   'Miscellaneous'),
]
